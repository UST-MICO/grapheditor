 ...
 */
function calculateMultiline(text, height, x, y, linespacing = 'auto') {
 ...
 */
function wrapCharacters(newText, text, width, overflowChar) {
 ...
 * @param overflowChar wrapping mode
 */
function wrapWords(newText, text, width, overflowChar) {
